...
if (!class_exists('BVProtectFWRuleEngine_V648')) :
require_once dirname( __FILE__ ) . '/functions.php';

class BVProtectFWRuleEngine_V648 {
	use BVProtectFWRuleStringFunc_V648;
	use BVProtectFWRuleArrayFunc_V648;
	use BVProtectFWRuleMiscFunc_V648;
	use BVProtectFWRuleRequestFunc_V648;
	use BVProtectFWRuleWPFunc_V648;
	...
	const CONST_NAME_PREFIX = 'BVProtectFWRule_V648::';
	...
	public function evaluate($rule) {
		...
		} catch (BVProtectRuleError_V648 $e) {
			$this->error = $e;
		}
	}
