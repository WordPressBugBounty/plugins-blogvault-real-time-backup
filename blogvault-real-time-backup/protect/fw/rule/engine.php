...
if (!class_exists('BVProtectFWRuleEngine_V662')) :
require_once dirname( __FILE__ ) . '/functions.php';

class BVProtectFWRuleEngine_V662 {
	use BVProtectFWRuleStringFunc_V662;
	use BVProtectFWRuleArrayFunc_V662;
	use BVProtectFWRuleMiscFunc_V662;
	use BVProtectFWRuleRequestFunc_V662;
	use BVProtectFWRuleWPFunc_V662;
	...
	const CONST_NAME_PREFIX = 'BVProtectFWRule_V662::';
	...
	public function evaluate($rule) {
		...
		} catch (BVProtectRuleError_V662 $e) {
			$this->error = $e;
		}
	}
