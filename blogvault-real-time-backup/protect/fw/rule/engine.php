...
if (!class_exists('BVProtectFWRuleEngine_V644')) :
require_once dirname( __FILE__ ) . '/functions.php';

class BVProtectFWRuleEngine_V644 {
	use BVProtectFWRuleStringFunc_V644;
	use BVProtectFWRuleArrayFunc_V644;
	use BVProtectFWRuleMiscFunc_V644;
	use BVProtectFWRuleRequestFunc_V644;
	use BVProtectFWRuleWPFunc_V644;
	...
	const CONST_NAME_PREFIX = 'BVProtectFWRule_V644::';
	...
	public function evaluate($rule) {
		...
		} catch (BVProtectRuleError_V644 $e) {
			$this->error = $e;
		}
	}
