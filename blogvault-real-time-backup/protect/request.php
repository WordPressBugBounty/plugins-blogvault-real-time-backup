...
if (!class_exists('BVProtectRequest_V662')) :
class BVProtectRequest_V662 {
	public $ip;
	public $host = '';
	public $uri;
	public $method = '';
	...
	public $files;
	public $respcode;
	public $status = BVProtectRequest_V662::STATUS_ALLOWED;
	public $category = BVProtectRequest_V662::CATEGORY_NORMAL;
	...
	public function __construct($ip_header, $config) {
		$this->ip = BVProtectUtils_V662::getIP($ip_header);
		$this->timestamp = time();
	...
	public static function blacklistedCategories() {
		return array(
			BVProtectRequest_V662::CATEGORY_BOT_BLOCKED,
			BVProtectRequest_V662::CATEGORY_COUNTRY_BLOCKED,
			BVProtectRequest_V662::CATEGORY_USER_BLACKLISTED,
			BVProtectRequest_V662::CATEGORY_GLOBAL_BOT_BLOCKED
		);
	}

	public static function whitelistedCategories() {
		return array(BVProtectRequest_V662::CATEGORY_WHITELISTED);
	}
	...
	private function loadJsonParams() {
		...
		$_json_params = BVProtectUtils_V662::safeDecodeJSON(
			$this->raw_body,
			true,
